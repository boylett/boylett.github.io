  ...
  const content = [
    {
      ...
      content: [
        ...
        'I have written countless jQuery extensions, WordPress plugins, Magento components, complex database queries and various other scriptlets for use within larger scale projects, and am actively learning Node.js and Laravel.',
      ],
      thumbnail: false,
      links: [
        {
